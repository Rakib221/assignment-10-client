...
const Admin = ({ books }) => {
    ...
    return (
        <div style={{ display: 'flex' }}>
            <div class='w-64 mobile:w-12 md:w-64  h-max bg-gray-800 mt-0 sm:mt-0'>
                <div class='flex items-center justify-center -mt-px'>
                ...
                <nav class='mt-10'>
                    <Link
                        to='/admin/addBook'
                        onClick={toggleAddBooks}
                        class='flex items-center mt-5 py-2 px-8 mobile:px-2 md:px-8 text-gray-400 border-r-4 border-gray-800 hover:bg-gray-700 hover:text-gray-100 hover:border-gray-100'
                        href='#'
                    >
                        <svg
                            class='h-5 w-5'
                        ...
                        <span class='mx-4 mobile:hidden md:block font-medium'>
                            Add Books
                        </span>
                    </Link>
                ...
                <div class='absolute bottom-0 my-10'>
                    <Link
                        class='flex items-center py-2 px-8 mobile:px-2 md:px-8 text-gray-600 hover:text-gray-500'
                        href='#'
                    >
                        <svg
                            class='h-5 w-5'
            ...
            {isActive ? (
                ...
                <ManageBooks books={books}></ManageBooks>
            )}
        </div>
    );
};
